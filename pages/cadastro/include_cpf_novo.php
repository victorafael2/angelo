    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="cpf" name="cpf" value="<?php echo $cpf; ?>" maxlength="14"
...
<?php
 $isValidId = isset($id_funci) && !empty($id_funci);

 // Define dinamicamente o URL com base na condição
 $url = $isValidId ? 'pages/cadastro/update/update_usuario.php' :
     'pages/cadastro/add/add_usuario.php';
    ...
    $("#form_2").submit(function(e) {
        ...
        $("#form_2 input, #form_2 select").each(function() {
            if ($(this).val() === "" && !$(this).hasClass("choices__input") && $(this).attr(
                    "name") !== "dataDemissao" && $(this).attr("name") !== "idFuncioanrio") {
