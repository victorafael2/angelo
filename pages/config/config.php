...
<ul class="nav nav-underline" id="myTab" role="tablist">
    <li class="nav-item" role="presentation"><a class="nav-link active" id="home-tab" data-bs-toggle="tab"
            href="#tab-home" role="tab" aria-controls="tab-home" aria-selected="false" tabindex="-1"><span
                class="fas fa-user me-2"></span>Home</a></li>
    <li class="nav-item" role="presentation"><a class="nav-link" id="transporte_tab" data-bs-toggle="tab"
            href="#tab-transporte" role="tab" aria-controls="tab-transporte" aria-selected="false" tabindex="-1"><span
                class="fa-solid fa-bus me-2"></span>Auxilio Transporte</a>
    </li>
    <li class="nav-item" role="presentation"><a class="nav-link" id="alimentacao-tab" data-bs-toggle="tab"
            href="#tab-alimentacao" role="tab" aria-controls="tab-alimentacao" aria-selected="true"><span
                class="fa-solid fa-utensils me-2"></span>Auxilio Alimentação</a></li>

    <li class="nav-item" role="presentation"><a class="nav-link" id="operacoes-tab" data-bs-toggle="tab"
            href="#tab-operacoes" role="tab" aria-controls="tab-operacoes" aria-selected="true"><span
                class="fa-solid fa-utensils me-2"></span>Operações</a></li>

    <li class="nav-item" role="presentation"><a class="nav-link" id="filiais-tab" data-bs-toggle="tab"
            href="#tab-filiais" role="tab" aria-controls="tab-filiais" aria-selected="true"><span
                class="fa-solid fa-utensils me-2"></span>Filiais</a></li>

                <li class="nav-item" role="presentation"><a class="nav-link" id="areas-tab" data-bs-toggle="tab"
            href="#tab-areas" role="tab" aria-controls="tab-areas" aria-selected="true"><span
                class="fa-solid fa-utensils me-2"></span> Areas </a></li>

                <li class="nav-item" role="presentation"><a class="nav-link" id="cargos-tab" data-bs-toggle="tab"
            href="#tab-cargos" role="tab" aria-controls="tab-cargos" aria-selected="true"><span
                class="fa-solid fa-utensils me-2"></span> Cargos </a></li>
